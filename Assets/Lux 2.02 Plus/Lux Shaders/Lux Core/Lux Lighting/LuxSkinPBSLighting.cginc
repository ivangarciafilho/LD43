...
//	///////////////////////////////////////	
//	Direct lighting uses the Lux Skin BRDF
...
inline half4 LightingLuxSkinSpecular_Deferred (SurfaceOutputLuxSkinSpecular s, half3 viewDir, UnityGI gi, out half4 outDiffuseOcclusion, out half4 outSpecSmoothness, out half4 outNormal)
{
	half oneMinusReflectivity;
	s.Albedo = EnergyConservationBetweenDiffuseAndSpecular (s.Albedo, s.Specular, /*out*/ oneMinusReflectivity);
...
//	gbuffer0: Write original Albedo and Occlusion
	outDiffuseOcclusion = half4(s.Albedo, s.Occlusion);
//	gbuffer1: Write Normal, Translucency and Smoothness
	outSpecSmoothness = half4(EncodeOctahedronNormal(s.Normal), s.Translucency, s.Smoothness);
//	gbuffer2: Write diffuseNormal, curvature and Material ID
	outNormal = half4(EncodeOctahedronNormal(s.BlurredNormal), s.Curvature, 0.0);
