...
CGPROGRAM
#pragma surface surf LuxTranslucentSpecular vertex:WavingGrassVert addshadow
#pragma target 3.0
...
//	Add some variation to translucency.
	o.Translucency = saturate(c.g * 6 * (1.0 - snowMask));
	o.ScatteringPower = 4.0;
