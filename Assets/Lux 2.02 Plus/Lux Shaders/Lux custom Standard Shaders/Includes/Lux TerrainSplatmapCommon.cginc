...
#endif
{
	...
	mixedDiffuse = 0.0f;
		...
		mixedDiffuse += splat_control.b * tex2D(_Splat2, IN.tc_Control * _Splat2_ST.xy) * half4(1.0, 1.0, 1.0, defaultAlpha.b);
		mixedDiffuse += splat_control.a * tex2D(_Splat3, IN.tc_Control * _Splat3_ST.xy) * half4(1.0, 1.0, 1.0, defaultAlpha.a);
	#else
		...
		nrm += splat_control.b * tex2D(_Normal2, IN.tc_Control * _Splat2_ST.xy);
		nrm += splat_control.a * tex2D(_Normal3, IN.tc_Control * _Splat3_ST.xy);
