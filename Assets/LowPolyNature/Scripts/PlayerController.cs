...
public class PlayerController : MonoBehaviour
{
	...
	private int amountOfFootsteps;
	private int currentAvailableFootstep;
...
private void Inventory_ItemRemoved(object sender, InventoryEventArgs e)
	...
	{
		if (currentAvailableFootstep >= amountOfFootsteps) currentAvailableFootstep = 0;
		GameObject footStep = footsteps[currentAvailableFootstep];
