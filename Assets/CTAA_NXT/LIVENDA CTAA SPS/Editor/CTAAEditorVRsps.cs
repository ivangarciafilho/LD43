//Single Pass Stereo Render Mode Support CTAA NXT V2

using UnityEngine;
using System.Collections;
using UnityEditor;

[CustomEditor(typeof(CTAAVR_SPS))]
public class CTAAEditorVRsps : Editor
{
	...
	void OnEnable()
	{
        ...
        banner = Resources.Load("CTAA_LOGO_VRSPS", typeof(Texture2D)) as Texture2D;
