...
//VIRTUAL REALITY VERSION 2 MP
//Copyright Livenda Labs 2017-2020
//===============================================================
...
public class CTAAVR_OCULUS : MonoBehaviour {
	...
	[Range(1, 8)] public float TemporalStability     	   = 2.5f;
	[Space(5)]
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		CreateMaterials();
			...
			if (((rtAccum0 == null) || (rtAccum0.width != source.width)) || (rtAccum0.height != source.height))
			{
				...
				rtAccum0.filterMode = FilterMode.Trilinear;
			...
			if (((rtAccum1 == null) || (rtAccum1.width != source.width)) || (rtAccum1.height != source.height))
			{
				...
				rtAccum1.filterMode = FilterMode.Trilinear;
